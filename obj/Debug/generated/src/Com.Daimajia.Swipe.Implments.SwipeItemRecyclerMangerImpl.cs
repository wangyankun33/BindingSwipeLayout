...
namespace Com.Daimajia.Swipe.Implments {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.daimajia.swipe.implments']/class[@name='SwipeItemRecyclerMangerImpl']"
	[global::Android.Runtime.Register ("com/daimajia/swipe/implments/SwipeItemRecyclerMangerImpl", DoNotGenerateAcw=true)]
	public partial class SwipeItemRecyclerMangerImpl : global::Com.Daimajia.Swipe.Implments.SwipeItemMangerImpl {

		// Metadata.xml XPath field reference: path="/api/package[@name='com.daimajia.swipe.implments']/class[@name='SwipeItemRecyclerMangerImpl']/field[@name='mAdapter']"
		[Register ("mAdapter")]
		protected global::Android.Support.V7.Widget.RecyclerView.Adapter MAdapter {
			get {
				const string __id = "mAdapter.Landroid/support/v7/widget/RecyclerView$Adapter;";
		...
		static readonly JniPeerMembers _members = new XAPeerMembers ("com/daimajia/swipe/implments/SwipeItemRecyclerMangerImpl", typeof (SwipeItemRecyclerMangerImpl));
		...
		protected SwipeItemRecyclerMangerImpl (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer)
		{
		}

		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.daimajia.swipe.implments']/class[@name='SwipeItemRecyclerMangerImpl']/constructor[@name='SwipeItemRecyclerMangerImpl' and count(parameter)=1 and parameter[1][@type='android.support.v7.widget.RecyclerView.Adapter']]"
		[Register (".ctor", "(Landroid/support/v7/widget/RecyclerView$Adapter;)V", "")]
		public unsafe SwipeItemRecyclerMangerImpl (global::Android.Support.V7.Widget.RecyclerView.Adapter adapter) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Com.Daimajia.Swipe.Implments.SwipeItemRecyclerMangerImpl> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.daimajia.swipe.implments']/class[@name='SwipeItemRecyclerMangerImpl']/method[@name='bindView' and count(parameter)=2 and parameter[1][@type='android.view.View'] and parameter[2][@type='int']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.daimajia.swipe.implments']/class[@name='SwipeItemRecyclerMangerImpl']/method[@name='initialize' and count(parameter)=2 and parameter[1][@type='android.view.View'] and parameter[2][@type='int']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.daimajia.swipe.implments']/class[@name='SwipeItemRecyclerMangerImpl']/method[@name='updateConvertView' and count(parameter)=2 and parameter[1][@type='android.view.View'] and parameter[2][@type='int']]"

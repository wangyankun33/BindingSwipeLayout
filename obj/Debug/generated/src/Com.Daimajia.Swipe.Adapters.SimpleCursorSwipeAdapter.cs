...
namespace Com.Daimajia.Swipe.Adapters {
	...
	public abstract partial class SimpleCursorSwipeAdapter : global::Android.Support.V4.Widget.SimpleCursorAdapter, global::Com.Daimajia.Swipe.Interfaces.ISwipeAdapterInterface, global::Com.Daimajia.Swipe.Interfaces.ISwipeItemMangerInterface {
		static readonly JniPeerMembers _members = new XAPeerMembers ("com/daimajia/swipe/adapters/SimpleCursorSwipeAdapter", typeof (SimpleCursorSwipeAdapter));
		...
		protected unsafe SimpleCursorSwipeAdapter (global::Android.Content.Context context, int layout, global::Android.Database.ICursor c, string[] from, int[] to) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			const string __id = "(Landroid/content/Context;ILandroid/database/Cursor;[Ljava/lang/String;[I)V";

			if (((global::Java.Lang.Object) this).Handle != IntPtr.Zero)
				return;

			IntPtr native_from = JNIEnv.NewArray (from);
			IntPtr native_to = JNIEnv.NewArray (to);
			try {
				JniArgumentValue* __args = stackalloc JniArgumentValue [5];
				__args [0] = new JniArgumentValue ((context == null) ? IntPtr.Zero : ((global::Java.Lang.Object) context).Handle);
				__args [1] = new JniArgumentValue (layout);
				__args [2] = new JniArgumentValue ((c == null) ? IntPtr.Zero : ((global::Java.Lang.Object) c).Handle);
				__args [3] = new JniArgumentValue (native_from);
				__args [4] = new JniArgumentValue (native_to);
				var __r = _members.InstanceMethods.StartCreateInstance (__id, ((object) this).GetType (), __args);
				SetHandle (__r.Handle, JniHandleOwnership.TransferLocalRef);
				_members.InstanceMethods.FinishCreateInstance (__id, this, __args);
			} finally {
				if (from != null) {
					JNIEnv.CopyArray (native_from, from);
		...
		protected unsafe SimpleCursorSwipeAdapter (global::Android.Content.Context context, int layout, global::Android.Database.ICursor c, string[] from, int[] to, int flags) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			const string __id = "(Landroid/content/Context;ILandroid/database/Cursor;[Ljava/lang/String;[II)V";
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Com.Daimajia.Swipe.Adapters.SimpleCursorSwipeAdapter> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
	...
	internal partial class SimpleCursorSwipeAdapterInvoker : SimpleCursorSwipeAdapter {
		...
		static readonly JniPeerMembers _members = new XAPeerMembers ("com/daimajia/swipe/adapters/SimpleCursorSwipeAdapter", typeof (SimpleCursorSwipeAdapterInvoker));
